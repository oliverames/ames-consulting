...
const definitions = [
  ...
  },
  {
    ...
    story: {
      title: "Stay through the change in light",
      paragraphs: [
  ...
  },
  {
    ...
    story: {
      title: "Use altitude to clarify the pattern",
      paragraphs: [
        "The strongest frames use height to reveal a relationship that is harder to see from the ground: a road through a valley, tracks across snow, or buildings arranged around water.",
        "The collection moves across several years and places, but it keeps returning to those lines, shapes, and changes in scale.",
      ],
    },
  },
];
