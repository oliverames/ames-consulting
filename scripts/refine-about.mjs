...
const credentials = `<section class="about-credentials"><div class="section-heading"><p class="eyebrow">Education, credentials, and tools</p><h2>The training and software behind the work.</h2><p>Credentials, education, and the practical toolkit I use to deliver the work.</p></div><article class="about-education"><p class="eyebrow">Education · 2013–2017</p><h3>Boston University</h3><p>Bachelor of Science in Science Education, cum laude</p></article><div class="brand-mark-grid">${marks}</div><div class="about-tool-list"><p class="eyebrow">Also in the toolkit</p><p>Adobe Creative Cloud, photography, video and podcast production, livestreaming, HTML and CSS, social publishing, A/B testing, accessibility review, and performance reporting.</p></div></section>`;
