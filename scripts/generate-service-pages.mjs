...
const pages = [
  ...
  },
  {
    ...
    projects: [
      ...
      ["Giron Family, Fall 2025", "A fall family session designed as a complete, browsable gallery.", "../../work/giron-family-fall-2025/"]
    ],
  },
  {
...
const indexCards = SERVICES.map(({ slug, title }) => {
  ...
  return `<a class="service-project" href="./${slug}/"><span class="service-project__arrow" aria-hidden="true">→</span><h3>${title}</h3><p>${page.intro}</p><span class="service-project__link">Read about this work</span></a>`;
}).join("");
