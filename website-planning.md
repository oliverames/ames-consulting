...
- **Backend:** [Local JSON](https://micro.blog)
...
Avery wants a unified content stream, not separate silos.

- **Content Source:** All posts live in Local JSON.
...
- Use Local JSON API or Hugo templates (if hosted on MB) or static site generator fetching from MB.
- Keep it simple: One content pipe, multiple views.

## Agent Team Strategy
Avery wants to build this using a team of specialized AI agents, inspired by the concept of turning specs into skills.
...
2. **Orchestrator:** Claude Opus 4.5 takes Avery's direction + the spec skills to drive the design.
