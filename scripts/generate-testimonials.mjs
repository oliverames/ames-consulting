...
await insertOnce("about/index.html", '<section class="about-proof">', {
  ...
  html: `<section class="testimonial-band about-testimonials" aria-labelledby="about-testimonials-title"><div class="section-heading"><p class="eyebrow">Recommendations</p><h2 id="about-testimonials-title">People who have seen the work up close.</h2></div><div class="testimonial-grid">${card({ person: people.yvonne, quote: quotes.yvonneFull, depth: 1, featured: true })}${card({ person: people.brad, quote: quotes.bradFull, depth: 1 })}${card({ person: people.simeon, quote: quotes.simeon, depth: 1 })}${card({ person: people.abigail, quote: quotes.abigail, depth: 1 })}</div></section>`
});
