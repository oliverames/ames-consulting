...
const credentials = `<section class="about-credentials"><div class="section-heading section-heading--standard"><h2>Education, credentials, and tools</h2><p class="section-heading__statement">What I studied and the tools I use.</p></div><article class="about-education"><p class="eyebrow">Education · 2013–2017</p><h3>Boston University</h3><p>Bachelor of Science in Science Education, cum laude</p></article><div class="brand-mark-grid">${marks}</div><div class="about-tool-list"><p class="eyebrow">Also in the toolkit</p><p>Adobe Creative Cloud, photography, video and podcast production, livestreaming, Swift, JavaScript and TypeScript, Node.js, HTML and CSS, Git and GitHub, APIs and Model Context Protocol, automation, social publishing, A/B testing, accessibility review, and performance reporting.</p></div></section>`;
