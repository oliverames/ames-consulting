...
const XML_PATH = ".context/attachments/2025-11-09 All Financial Wellness Blogs.xml";
const OUTPUT_PATH = "assets/data/financial-wellness-posts.json";
...
async function parseWpExport() {
  ...
  const output = {
    posts,
    meta: {
      source: "Sample Financial Cooperative Blog",
