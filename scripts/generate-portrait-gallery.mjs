...
const pages = [
  {
    ...
    html: pageShell({
      ...
      body: `<header class="case-hero case-hero--portrait"><p class="eyebrow">Portrait collection · EastRise</p><h1>EastRise formal portraits</h1><p>I made this portrait library for public profiles, press materials, and organizational communications.</p><p class="portrait-count">${eastRiseSeries.images.length} portraits in this collection.</p></header>${gallery(eastRiseSeries)}<section class="case-section"><h2>How I made the set</h2><p>I used consistent framing, natural light, and careful editing across the collection. The public archive includes both color and black-and-white portraits.</p></section><section class="case-section"><h2>Collection provenance</h2><p>Seventeen leadership portraits were verified against <a href="${eastRiseSeries.sourcePage}" rel="noopener">EastRise’s leadership page</a> on July 29, 2026. Yvonne Garand’s portrait was published by VSECU on <a href="${yvonneSourcePage}" rel="noopener">Facebook</a> on March 8, 2023. Twenty-three portraits were verified on their public EastRise source pages on March 20, 2026. Luke Buglion Gluck’s additional suit portrait was published by EastRise on <a href="${lukeSuitSource.sourcePage}" rel="noopener">Facebook</a> on May 21, 2024.</p></section>`,
    }),
  },
  {
    ...
    html: pageShell({
      ...
      body: `<header class="case-hero case-hero--portrait"><p class="eyebrow">Portrait collection · Blue Cross Vermont · 2026</p><h1>Blue Cross Vermont portraits</h1><p>Senior team headshots and a portrait of Lindsay Segale for public profiles and organizational communications.</p><p class="portrait-count">${blueCrossSeries.images.length} portraits in this collection.</p></header>${gallery(blueCrossSeries)}<section class="case-section"><h2>How I made the set</h2><p>I used the same lighting and editing approach across the headshots while leaving room for each person’s expression and posture.</p></section>`,
    }),
  },
];
