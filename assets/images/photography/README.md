...
- **Naming**: `photo-1.jpg` through `photo-4.jpg` for the homepage strip; gallery-specific images use either `photo-N.jpg` (generic) or a short prefix like `lab-NN.webp`
